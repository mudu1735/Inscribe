...
const expectedAppSnippets = [
  ...
  "The editorial desk your newsroom was missing.",
  "product-stories.png",
...
for (const snippet of [
  ...
  "Editors and admins can return or approve newsroom stories, and submit or unsubmit stories they author.",
  "Writers can only submit or unsubmit stories they author.",
