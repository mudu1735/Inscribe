...
def _parse_tags(soup: BeautifulSoup, authors: list[str]) -> list[str]:
    # Import only tags/categories represented by article-page markup. Metadata
    # such as article:tag, keywords, and JSON-LD keywords may be hidden or
    # editorially generated by the CMS and should not become database tags.
    output: list[str] = []
